<%@ Page Page Title=""Language="C#"  MasterPageFile="~/APhone.Master" AutoEventWireup="true" CodeBehind="AddTariff.aspx.cs" Inherits="APhoneFrontEnd.AddTariff" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="height: 558px">
    <asp:Button ID="btnAdd" runat="server" style="z-index: 1; left: 155px; top: 490px; position: absolute; width: 70px; "  Text="Add"  />
