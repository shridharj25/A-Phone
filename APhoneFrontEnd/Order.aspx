...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="height: 550px; width: 1105px">
        ...
        <asp:Button ID="btnAdd" runat="server" style="z-index: 1; left: 171px; top: 475px; position: absolute" Text="Add" />
        <asp:Button ID="btnDelete" runat="server" style="z-index: 1; left: 98px; top: 522px; position: absolute" Text="Delete" />
