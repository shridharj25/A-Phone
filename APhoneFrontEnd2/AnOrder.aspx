...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="height: 550px; width: 1105px">
        <h1 style="width: 282px; height: 53px; position:absolute; top: 49px; left: 462px;" class="auto-style1">&nbsp;Order<br />
        </h1>
        <br/> 
        ...
        <asp:Button ID="btnOk" runat="server" style="z-index: 1; left: 146px; top: 523px; position: absolute; width: 123px;" Text="Ok" OnClick="btnOk_Click"/>
