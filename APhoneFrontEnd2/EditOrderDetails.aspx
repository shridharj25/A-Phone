<%@ Page Title="" Language="C#" MasterPageFile="~/APhone.Master" AutoEventWireup="true" CodeBehind="EditOrderDetails.aspx.cs" Inherits="APhoneFrontEnd2.EditOrderDetails" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="height: 550px; width: 1105px">
        <h1 style="width: 282px; height: 53px; position:absolute; top: 49px; left: 462px;" class="auto-style1">Edit Order<br />
        </h1>
          <br/> 
        ...
        <asp:Button ID="btnUpdate" runat="server" style="z-index: 1; left: 146px; top: 523px; position: absolute; width: 123px;" Text="Update" OnClick="btnUpdate_Click" />
  ...
  <asp:DropDownList ID="ddlTariffList" runat="server" style="z-index: 1; left: 145px; top: 364px; position: absolute; width: 220px">
        </asp:DropDownList>
                <asp:TextBox ID="txtOrderDate" runat="server" style="z-index: 1; left: 144px; top: 421px; position: absolute; width: 220px"></asp:TextBox>
        <asp:TextBox ID="txtPrice" runat="server" style="z-index: 1; left: 143px; top: 330px; position: absolute; width: 220px"></asp:TextBox>
        <asp:Label ID="lblOrderDate" runat="server" style="z-index: 1; left: 266px; top: 456px; position: absolute; width: 61px; text-align: left; margin-top: 8px;" Text="Order Date"></asp:Label>
         ...
         <asp:TextBox ID="txtOrderMadeBy" runat="server" style="z-index: 1; left: 502px; top: 178px; position: absolute; width: 220px"></asp:TextBox>

                <asp:Label ID="lblOrderMadeBy" runat="server" style="z-index: 1; left: 657px; top: 212px; position: absolute; width: 110px; text-align: left; margin-top: 8px;" Text="Order Made By"></asp:Label>
            <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 396px; top: 522px; position: absolute; width: 148px;"></asp:Label>
