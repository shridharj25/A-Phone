<%@ Page Title="" Language="C#" MasterPageFile="~/APhone.Master" AutoEventWireup="true" CodeBehind="Customer.aspx.cs" Inherits="APhoneFrontEnd2.Customer" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div style="height: 550px; width: 1105px">
        ...
        <asp:Button ID="btnEdit" runat="server" style="z-index: 1; left: 160px; top: 533px; position: absolute; width: 93px;" Text="Edit" OnClick="btnEdit_Click" />
        <asp:Button ID="btnDelete" runat="server" style="z-index: 1; left: 288px; top: 533px; position: absolute; width: 93px;" Text="Delete" OnClick="btnDelete_Click" />


        
        <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 666px; top: 538px; position: absolute"></asp:Label>
